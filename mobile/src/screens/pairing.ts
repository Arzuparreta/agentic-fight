export function renderPairingScreen(container: HTMLElement) {
  container.innerHTML = `
  ...
  const typeSelect = container.querySelector('#character-type') as HTMLSelectElement;
  const button = container.querySelector('#join-btn') as HTMLButtonElement;
